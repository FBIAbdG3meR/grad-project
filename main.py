...
mail = Mail("cbrncaveira@gmail.com", "gwww mlrk nsnf vbel", "cbrncaveira@gmail.com")
...
receiver_email = values.get(3, "abdelfattah.44.16@gmail.com")
...
mail.send_mail(dest=receiver_email, body="This is a test email", subject="You should see a python file", file_name="output.pdf",file_path="output.pdf")
